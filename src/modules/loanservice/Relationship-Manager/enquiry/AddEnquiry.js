      ...
      <div className="col-12 col-lg-9 col-xl-7">
        <div className="card shadow-2-strong card-registration" style={{borderRadius: '15px'}}>
          ...
          {/* <div className="row">
              <div className="col-md-6 mb-4 pb-2">
              <div data-mdb-input-init className="form-outline mb-4">
                  <input type="date" className="form-control form-control-lg" {...register('customerEnquiryDate')} hidden/>
                  <label hidden className="form-label" htmlFor="customerEnquiryDate">customerEnquiryDate</label>
                </div>
                </div>

              <div className="col-md-6 mb-4 pb-2">
               <div data-mdb-input-init className="form-outline datepicker w-100">
                 <input type="time" className="form-control form-control-lg" {...register('customerEnquiryTime')} hidden/>
                 <label hidden htmlFor="customerEnquiryTime" className="form-label">customerEnquiryTime</label>
               </div>
            </div>  
          </div> */}
